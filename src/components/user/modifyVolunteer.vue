  ...
  <el-form style="margin-top:50px" label-width="10px" :label-position="labelPosition" ref="LoginFormRef" :model="user"  class="login_form">
    ...
    <el-form-item label="个人信息" prop="password">
      ...
      <div>
        ...
        <el-input id="checkin_date" style="width: 350px" placeholder="访问日期" v-model="user.description" prefix-icon="el-icon-lock"></el-input>
        <label for="checkout_date">离开日期:</label>
        <el-input id="checkout_date" style="width: 350px" placeholder="离开日期" v-model="user.description" prefix-icon="el-icon-lock"></el-input>
      </div>
      <div>
